...
export class TradingExecutionController {
  constructor(
    private readonly tradingExecutionService: TradingExecutionService,
  ) {}
  ...
  async create(
    @Body() createTradingExecutionDto: CreateTradingExecutionDto,
  ...
  async update(
    @Param('id') id: string,
    @Body() updateTradingExecutionDto: UpdateTradingExecutionDto,
  ): Promise<TradingExecution> {
