...
export class AlertController {
  ...
  @ApiOperation({
    summary:
      '[translate:Obtener la lista de todas las alertas o buscar por email]',
  })
  @ApiResponse({
    status: 200,
    description: '[translate:Lista de alertas obtenida correctamente.]',
  })
  @ApiQuery({
    name: 'email',
    required: false,
    description: '[translate:Email para buscar una alerta específica]',
  })
  ...
  @ApiResponse({
    status: 200,
    description: '[translate:Alerta obtenida correctamente.]',
  })
  @ApiResponse({
    status: 404,
    description: '[translate:Alerta no encontrada.]',
  })
  ...
  @ApiCreatedResponse({
    description: '[translate:Alerta creada correctamente.]',
  })
  @ApiResponse({
    status: 201,
    description: '[translate:Alerta creada correctamente.]',
  ...
  @ApiResponse({
    status: 200,
    description: '[translate:Alerta actualizada correctamente.]',
  })
  @ApiResponse({
    status: 404,
    description: '[translate:Alerta no encontrada.]',
  ...
  @ApiResponse({
    status: 200,
    description: '[translate:Alerta eliminada correctamente.]',
  })
  @ApiResponse({
    status: 404,
    description: '[translate:Alerta no encontrada.]',
