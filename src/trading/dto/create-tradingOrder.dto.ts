...
export class CreateTradingOrderDto {
  ...
  @ApiProperty({
    description: 'ID único de cliente para la orden',
  ...
  @ApiPropertyOptional({
    description: 'Ganancias o pérdidas',
    type: 'number',
    format: 'decimal',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Límite máximo de pérdida diaria permitido para esta operación',
  })
  @IsOptional()
  @IsDecimal()
  maxDailyLoss?: number;
  ...
  @ApiPropertyOptional({
    description: 'Máximo drawdown permitido para la cuenta al intentar operar',
  })
  @IsOptional()
  @IsDecimal()
  maxDrawdown?: number;
  ...
  @ApiPropertyOptional({
    description: 'Exposición máxima permitida por símbolo',
  })
  @IsOptional()
  @IsDecimal()
  ...
  @ApiPropertyOptional({
    description: 'Hora UTC inicial permitida para ejecutar la orden',
    minimum: 0,
    maximum: 23,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Hora UTC final permitida para ejecutar la orden',
    minimum: 0,
    maximum: 23,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Motivo o señal del bot para auditar la decisión',
  })
  @IsOptional()
  @IsString()
