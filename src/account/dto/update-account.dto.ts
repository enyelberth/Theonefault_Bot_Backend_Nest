...
export class UpdateAccountDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Email único de la cuenta',
  })
  @IsOptional()
  @IsEmail()
  email?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Contraseña actualizada de la cuenta',
  })
  @IsOptional()
  @IsString()
  @Length(6, 128)
  ...
  @ApiPropertyOptional({
    ...
    description: 'Clave API actualizada',
  })
  @IsOptional()
  @IsString()
  apiKey?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Secreto asociado a la API actualizado',
  })
  @IsOptional()
  @IsString()
  apiSecret?: string;
