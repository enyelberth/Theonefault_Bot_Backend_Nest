...
export class CryptoPriceController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The crypto price entry has been successfully created.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns all crypto price entries.',
  })
  findAll() {
  ...
  @ApiParam({
    name: 'id',
    description: 'The ID of the crypto price entry',
    example: 1,
  })
  @ApiResponse({
    status: 200,
    description: 'Returns the crypto price entry with the specified ID.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The crypto price entry has been successfully updated.',
  })
  @ApiResponse({ status: 404, description: 'Crypto price entry not found.' })
  update(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 200,
    description: 'The crypto price entry has been successfully deleted.',
  })
  @ApiResponse({ status: 404, description: 'Crypto price entry not found.' })
