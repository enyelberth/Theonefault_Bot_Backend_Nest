export class StrategyRuntimeUtils {
  ...
  static calculateSleepDuration(minMs?: number, maxMs?: number, defaultMinMs: number = 15000): number {
  ...
  static async sleepInterruptible(ms: number, shouldContinue: () => boolean, sliceMs: number = 250): Promise<void> {
